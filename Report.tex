...
H2=tf(num_digital, denum_digital, Te2, 'Variable', 'z');
    ...
    \begin{flushleft}
            ...
            \captionof{figure}{Plot of \(omega'(t)\) and \(omega'_f(t)\))}
            \label{Figure13}
        \end{flushleft}
    \columnbreak
    To obtain this plot :
...
legend({"omega'(t) unfiltered", "omega'(t) filtered"})
    ...
    \begin{flushleft}
            ...
            \captionof{figure}{Plot of DFT(\(omega'(t)\)) and DFT(\(omega'_f(t)\))}
            \label{Figure11}
        \end{flushleft}
    \columnbreak
    \begin{flushright}
            \includegraphics[width=1\linewidth]{Images/DFT_omega_dot_filtered_zoomed.png}
            \captionof{figure}{Plot of DFT(\(omega'(t)\)) and DFT(\(omega'_f(t)\)) zoomed}
            \label{Figure12}
        \end{flushright}
